...
public class CollectionUtil {
    ...
    private static int computeArrayListCapacity(int arraySize) {
        ...
        // 5L + arraySize + (arraySize / 10)是一个经验性的容量计算公式，目的是为 ArrayList 预留一定的额外空间，以减少频繁扩容的开销
        // 5：基础容量，确保即使 arraySize 很小，也有一定的初始空间
        // arraySize：数组大小，即传入的元素个数
        // arraySize / 10：预留一定的额外空间，以减少频繁扩容的开销
